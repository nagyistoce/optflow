...
/**
 * This class implements a morphing algorithm that computes 
 * an interpolated image between two images. Before 
 * cross-fading, the algorithm warps the first and 
 * second images by using the forward and inverse 
 * motion fields, respectively. This produces 
 * much better results than plain cross-fading. 
 * This algorithm uses dense motion vector 
